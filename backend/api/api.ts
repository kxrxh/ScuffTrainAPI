...
import { deleteTableDB, getTrains,getAllTrains, getPathInfoFull, getStateOfMovingTrain, getStationById, getStations, getTrainByIdFull, getTrainByIdShort, getTrainsByTime, getWagonStationTime, postImportStage, postImportStation, postImportTrain, postImportWagon } from "./handlers";
...
export function initApi(app: any) {
    ...
    routerV1.delete("/delete/db_table/:table", deleteTableDB) // *Done
